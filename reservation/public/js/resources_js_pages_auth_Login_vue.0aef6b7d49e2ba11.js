  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(['login'])), {}, {
    handleSubmitLogin: function handleSubmitLogin() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, _response$data$errors, _response$data$errors2, email, password;
              ...
              case 3:
                ...
                if (response.ok) {
                  ...
                  if (response.data.errors) {
                    _this.errorValidate = response.data.message.error;
                  } else {
                    email = (_response$data$errors = response.data.errors.email) !== null && _response$data$errors !== void 0 ? _response$data$errors : '';
                    password = (_response$data$errors2 = response.data.errors.password) !== null && _response$data$errors2 !== void 0 ? _response$data$errors2 : '';
