    ...
    handleSubmitLogin: function handleSubmitLogin() {
      ...
      if (response.ok) {
        ...
        if (response.data.message.error) {
          this.errorValidate = response.data.message.error;
        } else {
          var _response$data$errors, _response$data$errors2;

          var email = (_response$data$errors = response.data.errors.email) !== null && _response$data$errors !== void 0 ? _response$data$errors : '';
          var password = (_response$data$errors2 = response.data.errors.password) !== null && _response$data$errors2 !== void 0 ? _response$data$errors2 : '';
