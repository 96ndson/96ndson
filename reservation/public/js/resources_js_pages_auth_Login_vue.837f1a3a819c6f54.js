...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './plugins'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    Object(function webpackMissingModule() { var e = new Error("Cannot find module './plugins'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('getUser', function (data) {});
  },
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _services__WEBPACK_IMPORTED_MODULE_0__.LoginService.login(_this.form).then(function (result) {
                  _this.user = result.data;
                  alert('Đăng nhập thành công');
                  Object(function webpackMissingModule() { var e = new Error("Cannot find module './plugins'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('getUser', result.data);
                  ...
                  if (error.response.data.message.error) {
                    _this.errorValidate = error.response.data.message.error;
                  } else {
                    var _error$response$data$, _error$response$data$2;

                    var email = (_error$response$data$ = error.response.data.errors.email) !== null && _error$response$data$ !== void 0 ? _error$response$data$ : '';
                    var password = (_error$response$data$2 = error.response.data.errors.password) !== null && _error$response$data$2 !== void 0 ? _error$response$data$2 : '';
                    _this.errorValidate = email + password;
                  }
                });
