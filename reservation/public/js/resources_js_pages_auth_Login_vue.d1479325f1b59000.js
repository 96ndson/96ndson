  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(['login'])), {}, {
    handleSubmitLogin: function handleSubmitLogin() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, _response$error$data$, _response$error$data$2, email, password;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (response.ok) {
                  ...
                  if (response.error.data.message.error) {
                    _this.errorValidate = response.error.data.message.error;
                  } else {
                    email = (_response$error$data$ = response.error.data.errors.email) !== null && _response$error$data$ !== void 0 ? _response$error$data$ : '';
                    password = (_response$error$data$2 = response.error.data.errors.password) !== null && _response$error$data$2 !== void 0 ? _response$error$data$2 : '';
    ...
    handleLogout: function handleLogout() {
      ...
      if (check) {
        this.checkLogout().then(function (res) {
